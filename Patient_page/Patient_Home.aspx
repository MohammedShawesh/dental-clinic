<%@ Page Title="" Language="VB" MasterPageFile="~/Views/Patient_page/MasterPage_Patient.master" AutoEventWireup="false" CodeFile="Patient_Home.aspx.vb" Inherits="Views_Patient_page_Patient_Home" %>
          ...
          <div class="col-md-6 pr-md-5">
            <div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
<asp:TextBox ID="TextBox_paitName" runat="server" class="form-control" placeholder=" اسمك"  MaxLength="50"></asp:TextBox>
              </div>
              <div class="form-group">
